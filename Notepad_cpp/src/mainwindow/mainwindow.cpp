...
void MainWindow::on_actionAbrir_triggered()
{
    ...
    if (!file.open(QIODevice::ReadOnly | QFile::Text)) {
        QMessageBox::warning(this, "Aviso: ", "Não foi possível abrir o arquivo " + file.errorString());
        return;
    }
...
void MainWindow::on_actionSalvar_triggered()
{
    ...
    if (!file.open(QIODevice::WriteOnly | QFile::Text)) {
        QMessageBox::warning(this, "Aviso: ", "Não foi possível salvar o arquivo " + file.errorString());
        return;
    }
...
void MainWindow::on_actionSobre_o_aplicativo_triggered()
{
    ...
    message_about.setText("<h3 align='center'><pre>\tFeito por Lucas Turos\t\t\nFoi feito em Qt5 e C++</pre></h3>");
    message_about.exec();
}
